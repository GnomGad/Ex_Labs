        ...
        static void Ex_Lab4(string d)
        {
            ...
            while(true)
            {
                ...
                switch (k)
                {
                    ...
                    case "5": { Console_message(Ex, "5.", Color_Green); Labs.lab4.Ex_5(); break; };
                    case "6": { Console_message(Ex, "6.Ввести с клавиатуры текст. Программно найти в нем и вывести отдельно все слова, которые начинаются с большого латинского символа(от A до Z) и заканчиваются 2 цифрами, например «Petr93», «Johnny70», «Service02». Решить 2 способами: через обработку строки как массива и с помощью регулярных выражений.", Color_Green); break; };
                    case "7": { Console_message(Ex, "7.", Color_Green); break; };
